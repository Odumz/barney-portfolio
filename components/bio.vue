<template>
  <div class="lg:px-40 md:px-20 px-10 text-skin-primary">
    ...
    <p class="bio-text">When I'm not pushing pixels, I'm managing Sam Bain (a clothing brand that designs and manufactures Nigerian native attire for men), assisting fashion designers with creative communication, reading, and rooting for Manchester United and the Miami Heat.</p>
  </div>
</template>
