<template>
  <div class="text-skin-primary mx-40 grid gap-y-3 mt-14">
    <h1 class="text-5xl font-medium -mb-3">Product Design</h1>
    <h1 class="text-5xl font-medium -mb-3">UI + UX</h1>
    <h1 class="text-5xl font-medium">Creative Direction</h1>
    <!-- <p>
