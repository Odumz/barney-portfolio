<template>
  <div class="lg:px-40 md:px-20 px-10 text-skin-primary overflow-hidden">
    ...
    <div class="brief">
      ...
      <div class="image">
        <img src="https://res.cloudinary.com/griffintech/image/upload/v1636759511/barney/case_-_SB_Taxi_App_vaiy1j.png" alt="">
      </div>
    </div>
  </div>
</template>
...
<style scoped>
  ...
  .description {
    @apply text-justify lg:pr-5 py-2 leading-relaxed w-full lg:w-1/2 pb-10;
  }

  /* .image {
    @apply md:-mt-16 mx-auto;
  } */


  .image {
    @apply lg:w-5/9 lg:-mt-48 grid justify-items-center;
  }
</style>
