<template>
  <div class="text-skin-primary xl:px-70 lg:px-36 md:px-20 px-10 pb-20 overflow-hidden">
    ...
    <ul class="flex justify-center lg:justify-start gap-4">
      <li class="underlined"><a href="https://www.behance.net/barnabasina9e5" target="_blank" rel="nofollow">Behance</a></li>
      <li class="underlined"><a href="https://dribbble.com/baneyzinsane" target="_blank" rel="nofollow">Dribble</a></li>
      <li class="underlined"><a href="https://www.instagram.com/barneyzinsane/" target="_blank" rel="nofollow">Instagram</a></li>
    </ul>
  </div>
</template>
